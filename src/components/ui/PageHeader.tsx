...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(30, 58, 41, 0.8), rgba(30, 58, 41, 0.8)), url(${backgroundImage})`,
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      }}
    >
      <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary-900/40"></div>
